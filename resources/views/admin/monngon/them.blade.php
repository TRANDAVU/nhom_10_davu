		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<h3><div class="panel-heading"><b>Thêm món ngon</b></div></h3>
					<div class="panel-body">
						@if(Session::has('thongbao_10'))
							<div class="alert alert-success">{{Session::get('thongbao_10')}} </div>
						@endif
						<form method="post" enctype="multipart/form-data" action="{{route('themmonngon')}}">
