		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<h3><div class="panel-heading"><b>Sửa đơn vị tính</b></div></h3>
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-12">
									<div class="form-group" >
										...
										<input required type="text" name="name" class="form-control" value="{{$dv->donvitinh_ten}}">
									</div>
									
									<div class="form-group" >
										<label>Mô tả</label>
										<textarea required name="description">{{$dv->donvitinh_mo_ta}}</textarea>
