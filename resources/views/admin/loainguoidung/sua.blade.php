		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<h3><div class="panel-heading"><b>Sửa loại người dùng</b></div></h3>
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-12">
									<div class="form-group" >
										...
										<input required type="text" name="c1" class="form-control" value="{{$lnd->loainguoidung_ten}}">
									</div>

									<div class="form-group" >
										<label>Mô tả</label>
										<textarea required name="c2">{{$lnd->mo_ta}}</textarea>
