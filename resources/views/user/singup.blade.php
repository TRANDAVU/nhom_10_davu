...
<div class="container">
		<div id="content">
			<form action="{{route('dangkyuser')}}" method="post" class="beta-form-checkout">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="form-block col-md-8 offset-md-4">
							...
							<a href="{{ url('auth/google') }}" class="btn btn-primary" style="margin-right:15px;">
					         	<i class="fa fa-google fa-2x" style="color: white;"><b>G</b></i> 
					        </a> 
						</div>
					</div>
					<div class="col-sm-3"></div>
