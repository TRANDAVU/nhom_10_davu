...
<div class="inner-header">
        <div class="container">
            <div class="pull-left">
                <h6 class="inner-title" style="font-size: 20px;">Sản phẩm {{$ten_sp->loaisanpham_ten}}</h6>
                ...
                <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <ul class="aside-menu">
                                @foreach($loai as $l)
                                    <li><a href="{{route('loaisanpham',$l->id)}}"><img src="../user/image/images/{{$l->loaisanpham_anh}}" width="50" height="50"> {{$l->loaisanpham_ten}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="col-sm-9">
