    ...
    <div id="content" class="space-top-none">
        <div class="main-content " >
            ...
            <form id="contactform" name="contact" method="post" action="">
                ...
                <h2 style="text-align: center;"><b > CẬP NHẬT THÔNG TIN NGƯỜI DÙNG</b></h2>
                </p>
                <br>
                <br>
                <div class="row ">
                    <label for="name">Tên ảnh <span class="req">*</span></label>
                    <input type="text" name="c1" id="name" class="txt" tabindex="1" placeholder="Tên ảnh" required value="{{$user->avatar}}">
                </div>
                
                <div class="row">
                    <label for="name">Tên người dùng <span class="req">*</span></label>
                    <input type="text" name="c2" id="name" class="txt" tabindex="1" placeholder="Tên shop" required value="{{$user->name}}">
                </div>

                <div class="row">
                    <label for="email">Địa chỉ E-mail <span class="req">*</span></label>
                    <input type="email" name="c3" id="email" class="txt" tabindex="2" placeholder="address@domain.com" required value="{{$user->email}}">
                </div>

                <div class="row">
                    <label for="name">Địa chỉ <span class="req">*</span></label>
                    <input type="text" name="c4" id="name" class="txt" tabindex="1" placeholder="Địa chỉ" required value="{{$user->diachi}}">
                </div>
                <div class="row">
                    <label for="name">Số điện thoại <span class="req">*</span></label>
                    <input type="text" name="c5" id="name" class="txt" tabindex="1" placeholder="Số điện thoại" required value="{{$user->sodienthoai}}">
                </div>
                
                <div class="row">
                    <label for="name">Mật khẩu <span class="req">*</span></label>
                    <input type="text" name="c6" id="name" class="txt" tabindex="1" placeholder="cập nhật mật khẩu" required value="">
                </div>
