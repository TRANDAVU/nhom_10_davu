				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input type="text" id="adress" name="address" placeholder="Street Address" required value="{{$user->diachi}}">
						</div>
						

						<div class="form-block">
							<label for="phone">Điện thoại*</label>
							<input type="text" id="phone" name="phone" required value="{{$user->sodienthoai}}">
						</div>
										...
										<div class="media">
											...
											<div class="media-body" >
												<div class="media-body"style="height: 120px;">
													...
													<p class="table-option" style="padding-left: 15px;">
														<?php
															$shop=shop::where('id',$c->options->shop_id)->first();
														?>
														shop: {{$shop->tenshop}}
													</p>
