			...
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form method="post" enctype="multipart/form-data" action="{{route('themslide_shop')}}">
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-12">
									<div class="form-group" >
										<label>Tên ảnh</label>
										<input required type="text" name="anh" class="form-control">
									</div>
									...
									<a href="{{route('xem_slide_shop')}}" class="btn btn-danger" style="margin-left: 25px;">Hủy bỏ</a>
								</div>
							</div>
						</form>
