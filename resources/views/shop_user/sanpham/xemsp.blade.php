...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				@if(Session::has('thongbao_004'))
					<div class="alert alert-success">{{Session::get('thongbao_004')}} </div>
				@endif
				<div class="panel panel-primary">
					<h3><div class="panel-heading"><b>Xem sản phẩm<b></div> </h3>
								...
								<div class="card-body">
						            <form action="{{ route('import') }}" method="POST" enctype="multipart/form-data">
						               <input type="hidden" name="_token" value="{{csrf_token()}}">
						                <input type="file" name="file" class="form-control" value="0">
						                <br>
								...
								<table class="table table-bordered" style="margin-top:20px;">				
									...
									<tbody>
										...
										<tr>
											...
											<th style="color: black;">{{$mn->lohang_id}}</th>
											...
											<th style="color: black;"><?php echo $mn->sanpham_mo_ta;?></th>
											<th style="color: black;">{{number_format($mn->gia_tien)}} vnđ</th>
