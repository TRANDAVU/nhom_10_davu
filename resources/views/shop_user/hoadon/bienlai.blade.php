    ...
    <div id="page" class="page">
        <div class="header">
            <?php 
                ...
                $donhang=donhang::where('khachhang_id',$ttbl->id)->first();
                $spdat=chitietdonhang::where('donhang_id',$donhang->id)->get();
            ?>
        ...
        <div class="panel-body">
            <table class="table table-bordered" style="margin-top:20px;">
                ...
                <tbody>
                    <tr>
                        <th name='name' width="25%">{{$ttbl->khachhang_ten}}</th>
                        <th name='email'width="25%">{{$ttbl->khachhang_email}}</th>
                        <th name='address' width="25%">{{$ttbl->khachhang_sdt}}</th>
                        <th name='phone'width="25%">{{$ttbl->khachhang_dia_chi}}</th>
                    </tr>
                </tbody>
            </table>
        ...
        <td class="cotSo">
           <h4><b> {{number_format($tien+$tien*0.1)}} vnd</b></h4>
        </td>
        </tr>
        </table>
