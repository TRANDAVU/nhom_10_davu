		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<h3><div class="panel-heading"><b>Sửa nguyên liệu sản xuất</b></div></h3>
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-12">
									...
									<div class="form-group" >
										...
										<textarea required name="c3">{{$nguyenlieusanxuat->nguyenlieusanxuat_phanbon}}</textarea>
									...
									<div class="form-group" >
										...
										<textarea required name="c4">{{$nguyenlieusanxuat->nguyenlieusanxuat_hatgiong}}</textarea>
										<script type="text/javascript">
									...
									<div class="form-group" >
										...
										<textarea required name="c5">{{$nguyenlieusanxuat->nguyenlieusanxuat_nhienlieu}}</textarea>
										<script type="text/javascript">
									...
									<div class="form-group" >
										...
										<textarea required name="c6">{{$nguyenlieusanxuat->nguyenlieusanxuat_thuottrusau}}</textarea>
										<script type="text/javascript">
