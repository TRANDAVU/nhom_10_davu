		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<h3><div class="panel-heading"><b>Sửa sản phẩm</b></div></h3>
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-12">
									...
									<div class="form-group" >
										...
										<input required id="img" type="text" name="c3" class="form-control " value='{{$sanpham->sanpham_ten}}'>
									</div>
									...
									<div class="form-group" >
										...
										<input required id="img" type="text" name="c4" class="form-control " value='{{$sanpham->sanpham_anh}}'>
									</div>

									<div class="form-group" >
										<label>Miêu tả</label>
										<textarea required name="c5">{{$sanpham->sanpham_mo_ta}}</textarea>
									...
									<div class="form-group" >
										...
										<input required id="img" type="text" name="c8" class="form-control " value='{{$sanpham->gia_tien}}'>
									</div>

									<div class="form-group" >
										<label>% khuyến mãi</label>
										<input required id="img" type="text" name="c9" class="form-control " value='{{$sanpham->phan_tram_km}}'>
									</div>
									...
									<a href="{{route('xemsanphamshop')}}" class="btn btn-danger" style="margin-left: 25px;">Hủy bỏ</a>
