							...
							<div class="table-responsive">
								<table class="table table-bordered" style="margin-top:20px;">				
									...
									<tbody>
										...
										<tr>
											<td style="color: black;">{{$dh->dhid}}</td>
											<td style="color: black;">{{$dh->khachhang_id}}</td>
											<td style="color: black;">{{$dh->khachhang_ten}}</td>
											<td style="color: black;">{{$dh->khachhang_email}}</td>
											<td style="color: black;">{{$dh->khachhang_sdt}}</td>
											<td style="color: black;">{{$dh->khachhang_dia_chi}}</td>
											...
											<td>
												<a href="{{route('suadonhangshop',$dh->dhid)}}" class="btn btn-success" ><i class="fa fa-trash" aria-hidden="true"></i> Sửa</a>
												
												<a href="{{route('xoadonhangshop',$dh->dhid)}}" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa phần tử này ?')"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
											</td>
										</tr>
										@endforeach
									</tbody>
