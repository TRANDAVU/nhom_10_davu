		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<h3><div class="panel-heading"><b>Thêm điểm sản xuất</b></div></h3>
					<div class="panel-body">
						@if(Session::has('thongbao_9'))
							<div class="alert alert-success">{{Session::get('thongbao_9')}} </div>
						@endif
						<form method="post" enctype="multipart/form-data" action="{{route('themdiadiemsx')}}">
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-12">
									...
									<div class="form-group" >
										<label>Miêu tả</label>
										<textarea required name="c8"></textarea>
