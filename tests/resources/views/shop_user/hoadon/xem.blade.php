								...
								<table class="table table-bordered" style="margin-top:20px;">				
									<thead>
										<tr class="bg-primary">
											...
											<th style="color: black;">ID đơn hàng</th>
											<th style="color: black;">Ảnh sản phẩm</th>
											<th style="color: black;">Số lương</th>
									...
									<tbody>
										...
										<tr>
											<th style="color: black;">{{$ct->ctdhid}}</th>
											<th style="color: black;">{{$ct->sanpham_id}}</th>
											<th style="color: black;">{{$ct->dhid}}</th>
											...
											<th style="color: black;">{{number_format($ct->chitietdonhang_thanh_tien)}} vnđ</th>
											
											<td>
												<a href="{{route('xoahoadonshop',$ct->ctdhid)}}" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa phần tử này ?')"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
											</td>
										</tr>
										@endforeach
