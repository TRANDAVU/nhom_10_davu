<div id="header">
                ...
                <div class="container">
                    ...
                    <div class="pull-right auto-width-right">
                        <ul class="top-details menu-beta l-inline">
                            @if(Auth::check()==true)
                            <li style="padding-top: 10px; width: 200px;"><span> <img alt="" src="../user/image/images/product-8.jpg" width="40" height="35"><a>Hello  @if(empty(Auth::user()->name)) {{Auth::user()->email}} @else {{Auth::user()->name}} @endif</a></span></li>
            ...
            <div class="header-body">
                <div class="container beta-relative">
                    <div class="pull-left">
                        <a href="{{route('trangchu')}}" id="logo"><h2 style="color: green; text-align: center;"><b>VEGEFOODS</b></h2>Chúng tôi đảm bảo chất lượng cho từng sản phẩm</a>
                        <br><br>
                    </div>
                    <div class="pull-right beta-components space-left ov">
                        ...
                        <div class="beta-comp">
                            <a href="{{route('giohang')}}" class="beta-btn primary text-center">
                                <i class="fa fa-shopping-cart" style="font-size: 15px;"> Giỏ hàng ( @if(Cart::count()>0) {{Cart::count()}} @else Trống @endif )</i>
                            </a>
                            <!-- .cart -->
                        </div>
                    </div>
